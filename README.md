...
These public utility URLs are generated during normal site builds.

- [robots.txt](https://segunakinyemi.com/robots.txt) advertises both sitemaps. Generated from [docs/robots.txt](docs/robots.txt).
- [sitemap.xml](https://segunakinyemi.com/sitemap.xml) lists site pages and posts. Generated by `jekyll-sitemap`.
- [speaking-images.xml](https://segunakinyemi.com/speaking-images.xml) lists the Speaking gallery's display images. Generated from [docs/speaking-images.xml](docs/speaking-images.xml) using the existing gallery photo list.
- [feed.xml](https://segunakinyemi.com/feed.xml) provides the blog's Atom feed. Generated by `jekyll-feed`.
