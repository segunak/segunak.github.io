...
If you've ever browsed the professional social network [Blind](https://teamblind.com/), you'll see employees from across tech congregating to discuss, debate, and seek advice related to leveling. Just like Vegeta, many of us define ourselves by a leveling system that's meant to determine our value, potential, and power within a company. There are good reasons for having levels, but things become dangerous when we start viewing our careers through the lens of a corporation's estimation of our abilities.
