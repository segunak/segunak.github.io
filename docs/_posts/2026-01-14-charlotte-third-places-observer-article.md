...
classes: wide
header:
  teaser: /assets/images/misc/SegunAkinyemi-CommonMarket-SouthEnd.jpg
categories:
  - blog
tags:
  - miscellaneous
...
So, after moving to Charlotte during the pandemic, once things opened up, I did exactly that. I took full advantage of my remote work status to hang out anywhere and everywhere around the city. In 2024, I turned all that info into a website, [Charlotte Third Places](https://www.charlottethirdplaces.com/). I wrote about how I built the site [in this post](https://segunakinyemi.com/blog/charlotte-third-places-tech-stack/), although a lot has changed since then. Improving the site in my free time has become my go to hobby whenever I've got a spare moment.

All that said, the point is I got to chat with [The Charlotte Observer](https://www.charlotteobserver.com/) about the project, how it was built, where the idea came from, my goals for it, and more. Check out the article below!
