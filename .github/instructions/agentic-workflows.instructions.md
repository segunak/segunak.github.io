...
Every gh-aw workflow source file must include GitHub Copilot inference through the GitHub Actions token:
...
This repository already has a pre-commit hook that compiles staged workflow source files. Keep `core.hooksPath` set to `.githooks` locally.
